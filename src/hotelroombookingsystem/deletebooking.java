...
void resafe()
{
    try
	    ...
	    File file = new File("Bookingnew.txt");
            ...
            while (inputFile.hasNext())
            {
                ...
                deletebooking.Booking room = new deletebooking.Booking(n,i,p,e,r,d,dts,da);
            ...
            inputFile.close();
            JOptionPane.showMessageDialog(null,"Record has been deleted successfully!","SYSTEM",JOptionPane.INFORMATION_MESSAGE);
            file.delete();
        }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Delete Booking");
        ...
        cbDos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbDosActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {cbDos, cbID, jDateChooser1, jLabel2, jLabel3, jLabel4, jLabel5, jLabel6, jLabel7, jLabel8, jLabel9, txtCheckout, txtEmail, txtICPP, txtName, txtPhone});
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null,"Please select a user to delete","SYSTEM",JOptionPane.ERROR_MESSAGE);
        }
        else
        {
            try
...
try
      {
          cbICNO.removeAllItems();
          cbICNO.addItem("Please Select");
          Scanner inputFile = new Scanner(file);
        test: while (inputFile.hasNext())
        {
              String n = inputFile.nextLine();
    ...
    private void cbICNOItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbICNOItemStateChanged
        ...
        try
        {
            ...
            while (inputFile.hasNext())
            {
                ...
                String ic = inputFile.nextLine();
                int phone = inputFile.nextInt();
                inputFile.nextLine();
                String email = inputFile.nextLine();
                String roomid = inputFile.nextLine();
                String dayin = inputFile.nextLine();
                String dts = inputFile.nextLine();
                String dayout = inputFile.nextLine();
                inputFile.nextLine();

                Booking room = new Booking(name,ic,phone,email,roomid,dayin,dts,dayout);
                ...
                } else if (checkicpp.equals("Please Select"))
                {
                    txtName.setText("");
                    txtICPP.setText("");
                    txtPhone.setText("");
    ...
    private void cbDosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbDosActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbDosActionPerformed
