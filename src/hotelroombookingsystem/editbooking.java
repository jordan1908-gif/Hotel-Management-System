...
void resafe()
{
    try
	    ...
	    File file = new File("Bookingnew.txt");
            ...
            inputFile.close();
            JOptionPane.showMessageDialog(null,"Record has been updated successfully!","SYSTEM",JOptionPane.INFORMATION_MESSAGE);
            file.delete();
        }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Modify Booking");
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {cbDos, cbID, jDateChooser1, jLabel3, jLabel4, jLabel5, jLabel6, jLabel7, jLabel8, jLabel9, txtCheckout, txtEmail, txtICPP, txtName, txtPhone});
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {cbDos, cbID, jDateChooser1, jLabel2, jLabel3, jLabel4, jLabel5, jLabel6, jLabel7, jLabel8, jLabel9, txtCheckout, txtEmail, txtICPP, txtName, txtPhone});
...
try
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
      if (String.valueOf(cbICNO.getSelectedItem()).equals("Customer IC"))
      {
          JOptionPane.showMessageDialog(null,"Please Select a user to edit profile","SYSTEM",JOptionPane.ERROR_MESSAGE);
      }
      else
      {
        try
        {
            ...
            while (inputFile.hasNext())
            {
             ...
             String dayafter = room.getdateafter();
              ...
              if ((y2cx1>=0 && x2cx1<=0 || x2cx1>=0&&x2cy1<=0 || x2cx1>=0&&y2cy1>=0) && roomid.equals(String.valueOf(cbID.getSelectedItem())) && !(room.geticpp().equals(txtICPP.getText())))
              {
                  JOptionPane.showMessageDialog(null,"This room is not available","Error",JOptionPane.ERROR_MESSAGE); //error message
                  wrong++;
                  break;  
              }
                ...
                {
                     FileWriter fw = new FileWriter("Bookingnew.txt",true);
                    BufferedWriter bw = new BufferedWriter(fw);
                    bw.write(room.getName());
                    bw.newLine();
                    bw.write(room.geticpp());
    ...
    private void exitmenuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_exitmenuMouseClicked
        int n = JOptionPane.showConfirmDialog(null,"Would you like to exit from system?","Terminate System",JOptionPane.YES_NO_OPTION);//pop up box asking confirmation to exit the application
